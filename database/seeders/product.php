...
class product extends Seeder
{
    ...
    public function run()
    {
        $products = [
            ...
            [        
                'title' => 'Huawei P30',
                'description' => "Huawei’s re-badged P30 Pro New Edition was officially unveiled yesterday in Germany and now the device
has made its way to the UK.",
                'price' => 499,
...
Mercury level is 0%, so there are no side effects.",
                'price' => 70,
            ...
            [        
                ...
                'description' => "original fauji cereal muesli 250gm box pack original fauji cereals muesli fruit nuts flakes breakfast
cereal break fast faujicereals cerels cerel foji fouji",
                'price' => 46,
            ...
            [        
                ...
                'description' => "Package Include 6 Birds with Adhesive Tape Shape=> 3D Shaped Wooden Birds Material=> Wooden MDF, Laminated
3.5mm",
                'price' => 51,
                'discountPercentage' => 15.58,
                'rating' => 4.41,
            ...
            [        
                ...
                'description' => "Handcraft Chinese style art luxury palace hotel villa mansion home decor ceramic vase with brass fruit
plate",
                'price' => 60,
